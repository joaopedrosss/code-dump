...
---- Banco de Dados - Exercício Avaliativo
---- Aluno: João Pedro Simões da Silva Sousa

---- Formato
--- Parte A - Respostas das questões
--- Parte B - Banco de dados solicitado

--  P.S.: A fim de melhor vizualização, executar os queries por bloco de código e não o script todo.
---      O SGBD usado para confirmar as respotas foi o PostgreSQL.

--- CUIDADO: Ao executar o script no MySQL, substituir o tipo BYTEA por blob.
